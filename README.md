...
'enableUnauthorizedAccess' do not enable unauthorize access unless you fully understand unauthorized users can at least see your dashboard and at worst steal your tokens. Valid values are false and true.

'unauthorizedAccessPermission' do not change this value from 'undefined' unless your intent is allow a portion, possibly all, of your node and wallet functionality to be available on the listening IP without logging in. (NEVER USE ON MAINNET) Possible values are undefined, 'admin', 'invoice', and 'readonly'.
