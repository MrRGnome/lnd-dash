...
//}
    ...
    sendCoins: async function (transaction, user) {
        ...
        var call = new Promise((resolve) => {
            client.data.client.sendCoins({ addr: transaction.addr, amount: parseInt(transaction.amount), target_conf: transaction.target_conf ? parseInt(transaction.target_conf) : undefined, sat_per_byte: transaction.sat_per_byte ? parseInt(sat_per_byte) : undefined, send_all: transaction.send_all == 'true' ? true : undefined }, function (err, response) {
